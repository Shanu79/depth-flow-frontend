...
const ApiKeysPage = () => {
  ...
  return (
    // FIX: Added 'h-full flex-1' to ensure the component stretches to the bottom of the layout
    <div className="w-full h-full flex-1 relative text-white font-sans flex flex-col items-center overflow-hidden">
      ...
      <main className="w-full max-w-5xl mx-auto px-4 sm:px-8 py-8 sm:py-12 relative z-10 flex-1 flex flex-col">
        {/* Header Section */}
        <div className="mb-8 sm:mb-10 text-center sm:text-left shrink-0">
        ...
        <div className="flex flex-col gap-6 pb-8 sm:pb-0">
