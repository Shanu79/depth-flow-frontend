...
const ApiKeysPage = () => {
  ...
  return (
    <div className="flex-1 h-full relative p-8 flex flex-col overflow-hidden w-full font-sans text-white">
      ...
      <div className="max-w-4xl mx-auto relative z-10 flex flex-col h-full w-full gap-8 overflow-y-auto pb-10">
        ...
        <div className="bg-[#151124]/80 backdrop-blur-md border border-white/10 rounded-2xl p-8 shadow-[0_4px_20px_rgba(0,0,0,0.2)] shrink-0">
          ...
          <div className="bg-[#0a0710] border border-purple-500/20 p-6 rounded-xl overflow-x-auto relative group shadow-inner custom-scrollbar">
            ...
            >
              {copiedAdvanced ? <Check className="w-4 h-4 text-green-400" /> : <Copy className="w-4 h-4 text-gray-400 group-hover:text-white" />}
              {copiedAdvanced && (
            ...
            <pre className="text-[13px] font-mono leading-loose text-gray-300">
              ...
              <br />  -H <span className="text-yellow-300">"X-API-Key: {getAuthHeader()}"</span> \
              <br />  -H <span className="text-yellow-300">"accept: application/json"</span> \
              <br />  -H <span className="text-yellow-300">"Content-Type: multipart/form-data"</span> \
              <br />  -F <span className="text-blue-300">"file=@/path/to/your/image.jpg"</span> \
              <br />  -F <span className="text-blue-300">'payload={"{"}"motion":{"{"}"style":"dolly","amplitude":0.2{"}"},"render":{"{"}"duration":5{"}"},"plan":"free"{"}"}'</span>
            </pre>
          </div>
        </div>
